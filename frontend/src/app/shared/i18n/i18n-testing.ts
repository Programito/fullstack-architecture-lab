  ...
  es: {
    ...
    restaurantPos: {
      ...
      floorPlan: {
        ...
        deleteDialogTitle: 'Eliminar elemento del plano',
        deleteConfirm: '¿Eliminar este elemento del plano?',
        confirmDeleteElement: 'Eliminar elemento',
        cancelDeleteElement: 'Cancelar',
        table: 'Mesa',
        bar: 'Barra',
        kitchen: 'Cocina',
        entrance: 'Entrada',
