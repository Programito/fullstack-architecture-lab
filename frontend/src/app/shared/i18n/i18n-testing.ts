...
const TEST_TRANSLATIONS = {
  es: {
    ...
    restaurantPos: {
      ...
      preparationBoard: {
        title: 'Preparación',
        description: 'Mueve las líneas entre cocina, preparado y servido.',
        in_kitchen: 'En cocina',
        ready: 'Preparado',
        served: 'Servido',
        emptyColumn: 'No hay líneas en esta fase.',
        tableLabel: 'Mesa {{number}}',
        markReady: 'Marcar preparado',
        markServed: 'Marcar servido',
        directStation: 'Barra',
        notReadyWarning: 'Este producto todavía no está marcado como preparado.',
  ...
  en: {
    ...
    restaurantPos: {
      ...
      preparationBoard: {
        title: 'Preparation',
        description: 'Move lines between kitchen, ready, and served.',
        ...
        directStation: 'Bar',
        notReadyWarning: 'This product is not marked as ready yet.',
  ...
  ca: {
    ...
    restaurantPos: {
      ...
      preparationBoard: {
        title: 'Preparació',
        description: 'Mou les línies entre cuina, preparat i servit.',
        in_kitchen: 'A cuina',
        ready: 'Preparat',
        served: 'Servit',
        emptyColumn: 'No hi ha línies en aquesta fase.',
        tableLabel: 'Taula {{number}}',
        markReady: 'Marcar preparat',
        markServed: 'Marcar servit',
        directStation: 'Barra',
        notReadyWarning: 'Aquest producte encara no està marcat com a preparat.',
