...
function withAdditionalMenuImageTranslations<T extends Record<string, any>>(translations: T): T {
  ...
  clones['es'].restaurantPos.dashboard = {
    title: 'Analiticas del restaurante',
    description: 'Consulta el rendimiento historico del restaurante: ventas, productos y ocupacion.',
    ranges: { today: 'Hoy', '7d': '7 dias', '30d': '30 dias' },
    filters: {
      title: 'Filtros',
      ...
      rangeClamped: 'El rango maximo es de 1 ano; se ha ajustado la fecha.',
      show: 'Mostrar filtros',
      hide: 'Ocultar filtros',
      reset: 'Limpiar filtros',
      viewAsTable: 'Ver como tabla',
      viewAsChart: 'Ver como grafico',
    },
    tableHeaders: {
      date: 'Fecha',
      product: 'Producto',
    ...
    metrics: {
      ...
      orders: 'Pedidos',
      averageTicket: 'Ticket medio',
      dominantPayment: 'Metodo dominante',
      bestDayValue: 'Mejor dia: {{date}}',
      tableTurnover: 'Rotacion media de mesa',
      tableTurnoverValue: '{{minutes}} min',
      loading: 'Cargando metrica',
      vsIncrease: '{{pct}}% mas que el periodo anterior',
      vsDecrease: '{{pct}}% menos que el periodo anterior',
      vsFlat: 'Igual que el periodo anterior',
    },
    charts: {
      salesByDay: 'Ventas por dia',
      topProducts: 'Productos mas vendidos',
      paymentBreakdown: 'Ingresos por metodo de pago',
      paymentShare: 'Mix de pagos',
      averageTicketByDay: 'Ticket medio por dia',
    ...
    panelEmpty: {
      ...
      paymentBreakdownDescription: 'No hay ingresos por metodo para este periodo.',
    ...
    errors: { title: 'No se han podido cargar las analiticas' },
  ...
  clones['en'].restaurantPos.dashboard = {
    ...
    errors: { title: 'The analytics could not be loaded' },
  ...
  clones['ca'].restaurantPos.dashboard = {
    ...
    errors: { title: "No s'han pogut carregar les analitiques" },
