...
exports.seedMesaFlowReservationsDemo = seedMesaFlowReservationsDemo;
...
async function seedMesaFlowReservationsDemo(prisma) {
    ...
    const laura = (await prisma.customer.findFirst({ where: { organizationId: organization.id, name: 'Laura Gomez' } })) ??
    ...
    const diego = (await prisma.customer.findFirst({ where: { organizationId: organization.id, name: 'Diego Martin' } })) ??
        (await prisma.customer.create({
            data: {
                organizationId: organization.id,
                name: 'Diego Martin',
    ...
    const ana = (await prisma.customer.findFirst({ where: { organizationId: organization.id, name: 'Ana Ruiz' } })) ??
        (await prisma.customer.create({
            data: {
                organizationId: organization.id,
                name: 'Ana Ruiz',
    ...
    const sergio = (await prisma.customer.findFirst({ where: { organizationId: organization.id, name: 'Sergio Lopez' } })) ??
        (await prisma.customer.create({
            data: {
                organizationId: organization.id,
                name: 'Sergio Lopez',
...
function requiredTableId(tableIdByNumber, tableNumber) {
...
//# sourceMappingURL=mesaflow-reservations.seed.js.map