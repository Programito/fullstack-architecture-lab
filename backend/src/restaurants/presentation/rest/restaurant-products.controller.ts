...
export class RestaurantProductsController {
  ...
  async createProduct(
    ...
    await this.audit.record({
      ...
      changedFields: ['name', 'nameI18n', 'description', 'descriptionI18n', 'course', 'preparationRoute', 'priceCents', 'currency', 'imageUrl', 'modifierGroupIds', 'allergens', 'taxRateId'],
  ...
  async updateProduct(
    ...
    await this.audit.record({
      ...
      entityId: productId,
      entityLabel: product.displayName,
      changedFields: collectChangedFields(body, ['name', 'nameI18n', 'description', 'descriptionI18n', 'course', 'preparationRoute', 'priceCents', 'isAvailable', 'isVisible', 'imageUrl', 'modifierGroupIds', 'allergens', 'taxRateId']),
