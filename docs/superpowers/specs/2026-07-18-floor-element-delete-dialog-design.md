...
Se añadirán las mismas claves a `es`, `en` y `ca` para título, descripción de mesa, descripción de elemento decorativo, etiquetas de cancelar/eliminar y mensaje de error. Los tests de traducción usarán el helper existente.
